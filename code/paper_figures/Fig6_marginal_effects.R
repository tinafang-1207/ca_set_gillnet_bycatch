...
# Export
ggsave(plot_with_insert, filename=file.path(plotdir, "Fig6_marginal_effects_SL.png"), 
       width=5.6, height=4.19, units="in", dpi=600)
...
# Export
ggsave(plot_with_insert, filename=file.path(plotdir, "Fig6_marginal_effects_HS.png"), 
       width=5.6, height=4.19, units="in", dpi=600)
